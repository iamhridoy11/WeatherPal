...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
                <p class="heading">${parseInt((temp - 273.15) * 9/5 + 32)}&deg;F</p>
            ...
            card.innerHTML = `
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-1">${parseInt(feels_like - 273.15) * 9/5 + 32 }&deg;<sup>c</sup></p>
                    </div>
                </div>
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                            <div class="card card-sm slider-card">
                                ...
                                <p class="body-3">${parseInt((temp - 273.15) * 9/5 + 32)}&deg;F</p>
                            </div>
                `
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                li.innerHTML = `
                            <div class="icon-wrapper">
                                ...
                                <span class="span">
                                    <p class="title-2">${parseInt((temp_max - 273.15) * 9/5 + 32).toPrecision(2)}&deg</p>
                                </span>
                            </div>
